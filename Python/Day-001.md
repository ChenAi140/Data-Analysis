...
1. <font color="red">将 Python 添加到环境变量中，自定义安装</font>  
    ![01](../imgs/Day-001/01.png)  
    <br />
    
2. <font color="red">确定pip已经勾选上，很重要！下一步next</font>  
    ![02](../imgs/Day-001/02.png)  
    <br />

3. <font color="red">自行修改路径，然后 install，我这里是虚拟机只有C盘，所以没改路径</font>  
    ![03](../imgs/Day-001/03.png)  
    <br />

4. <font color="red">安装完成</font>  
    ![04](../imgs/Day-001/04.png)  
    <br />

5. <font color="red">检测安装是否成功，同时按住<kbd>win</kbd>+<kbd>R</kbd>，输入cmd，按回车，输入`python --version` 和`pip --version`显示 python 和 pip 的版本号即安装成功</font>  
